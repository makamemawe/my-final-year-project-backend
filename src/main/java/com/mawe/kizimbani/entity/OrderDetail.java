...
public class OrderDetail {
    ...
    public OrderDetail(String orderFullName, String orderFullOrder, Date orderDate , String orderContactNumber, String orderAlternateContactNumber, String orderStatus, Double orderAmount, Product product, User user, String transactionId) {
